<?php
include 'basic.php';
$sql = "SELECT * FROM cairo WHERE active=0";
$data = mysqli_query($conn, $sql);
if(isset($_GET["id"])){
  reserve_restore($_GET["id"]);
}
 ?>
  ...
  <div class="container">
    <div class="row">
      ...
      <table class="table table-white table-bordered table-striped">
          ...
          <td>
    <a class="btn btn-primary" href="cairo-rooms-trash.php?id=<?php echo $room ["room_number"]; ?>">Restore</a>
          </td>
          </tr>
          <?php } ?>
