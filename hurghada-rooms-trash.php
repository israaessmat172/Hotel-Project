<?php
include 'basic.php';
$sql = "SELECT * FROM hurghada WHERE active=0";
$data = mysqli_query($conn, $sql);
if(isset($_GET["id"])){
  hurghada_restore($_GET["id"]);
}
 ?>
  ...
  <div class="container">
    <div class="row">
      ...
      <table class="table table-white table-bordered table-striped">
          ...
          <td>
    <a class="btn btn-primary" href="hurghada-rooms-trash.php?id=<?php echo $room ["room_number"]; ?>">Restore</a>
          </td>
          </tr>
          <?php } ?>
