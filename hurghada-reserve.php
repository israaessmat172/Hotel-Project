...
$id =$_GET["id"];
if(isset($_POST["name"])){
  hurghada_reserve($_POST['name'],$_POST['phone'],$_POST['check_in'], $_POST['check_out'],$_POST['number_of_days'],$_POST['id']);
}
?>
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <form action="hurghada-reserve.php" method="post">
          ...
          <button type="submit" class="btn btn-primary" href="reserved.php">Done</button>
        </form>
        </div>
      </div>
   </body>
